  ...
  <div class="grid">
    ...
    <form action="" method="POST" class="form login">
      ...
      <div class="form__field">
        ...
        <input autocomplete="username" id="login__username" type="text" name="txt_email" class="form__input" placeholder="Username" required>
      </div>
      ...
      <div class="form__field">
        ...
        <input id="login__password" type="password" name="txt_password" class="form__input" placeholder="Password" required>
      </div>
    ...
    <p class="text--center">Not a member? <a href="option.html">Sign up now</a> <svg class="icon">
